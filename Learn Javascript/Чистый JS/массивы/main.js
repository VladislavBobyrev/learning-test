...
let vasya = { names: "Вася", surname: "Пупкин", id: 1 };
let petya = { names: "Петя", surname: "Иванов", id: 2 };
let masha = { names: "Маша", surname: "Петрова", id: 3 };

let us = [ vasya, petya, masha ];

let usersMapped = us.map(user => ({
